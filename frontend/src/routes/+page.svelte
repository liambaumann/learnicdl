...
<div class="font-montserrat max-w-3xl mx-auto py-10 px-4">
	...
	<div class="border-2 border-b-4 border-gray-300 rounded-xl divide-y divide-gray-200 overflow-hidden bg-white">
		{#each data.modules as module}
			...
			>
				...
				/>
				<span class="flex-1 text-base font-semibold text-slate-800">{module.title}</span>
				<Icon
